    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        List<User> users =
                Arrays.asList(
                        ...
                        new User("Frenkie", "De Jong", LocalDate.of(2021,4,20), "frank@inholland.nl","password", UserType.ROLE_CUSTOMER, new BigDecimal("1000.02"), new BigDecimal("250.02"), false),
                        new User("Kevin", "De Bruyne", LocalDate.of(2021,6,1), "cus","password", UserType.ROLE_CUSTOMER, new BigDecimal("1000.02"), new BigDecimal("250.02"), true),
